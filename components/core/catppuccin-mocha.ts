export default {
    "code[class*=\"language-\"]": { color: "#cdd6f4", background: "rgb(49,50,68)" },
    "pre[class*=\"language-\"]": { color: "#cdd6f4", background: "rgb(49,50,68)" },
